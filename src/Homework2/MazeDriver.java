...
public class MazeDriver {
	...
	public static void main(String[] args) throws IOException {
		...
		String menu = "Choose the Robot that you want to" + //D
				...
				"\n\n Type 1 for the Random Robot" +
				"\n Type 2 for the Righthand Robot";
		/**
			...
			switch (letter) {
				case '1':
					JOptionPane.showMessageDialog(null,
							"You chose the Random Robot", "RandomRobot", 1);
					Robot bot = new RandomRobot(maze); //show the bot the maze
				...
				case '2':
					...
					for (int k = 0; k < 1000000 && !botRight.solved(); k++)
					//this limits the robot's moves, in case it takes too long to find the exit.
					{
